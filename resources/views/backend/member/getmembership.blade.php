...
<div class="col-12 ">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('purchase.membership') }}" id="member_form" class="forms-sample" method="post">
                @csrf
                <input type="hidden" name="reg_code" value="{{ $member->reg_code }}">
                <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-dark" id="" name="name" value="{{ $member->user->name }}" placeholder="Name">
                                </div>
                                <div class="form-group col-12">
                                    <label for="">Email address <span class="text-danger">*</span></label>
                                    <input type="email" class="form-control form-control-sm border-dark" id="" name="email" value="{{ $member->user->email }}"  placeholder="Email">
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="rounded ">
                                        <div class="d-flex row ml-1 mt-1">
                                            <div class="col">
                                                <input type="radio" id="male" name="gender" {{ $member->gender == 1 ? 'checked':'' }} value="1">
                                                <label for="single">Male</label>
                                            </div>
                                            <div class="col">
                                                <input type="radio" id="female" name="gender" {{ $member->gender == 0 ? 'checked':'' }}  value="0">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="contact" class="form-control form-control-sm border-dark" id="" value="{{ $member->contact }}" placeholder="Mobile Number">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="current_weight" id="" value="{{ $member->initial_weight }}" class="form-control form-control-sm border-dark" value="0" min="0">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" value="10" name="discount" readonly id="discount" class="form-control border-dark form-control-sm" value="0" min="0" aria-label="Amount (to the nearest dollar)">
