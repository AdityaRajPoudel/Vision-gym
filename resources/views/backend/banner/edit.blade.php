...
<div class="col-12 ">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('banners.update',$banner->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary card-tabs">
                            ...
                            <div class="card-body row">
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" id="banner_title" class="form-control form-control-sm border-dark" name="banner_title" value="{{ old('banner_title')?old('banner_title'):$banner->banner_title }}">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" id="banner_order" class="form-control form-control-sm border-dark" name="banner_order" value="{{ old('banner_order')?old('banner_order'):$banner->banner_order }}">
                            ...
                            <div class="form-group col-md-9">
                                ...
                                <img class="" src="/storage/banner-image/{{ $banner->banner_image }}" alt="" width="150x" height="150px">
                                @else
                                <img src="{{ asset('assets/backend/images/logo.png') }}" alt="Banner Image" class="rounded" id="banner_image" width="150px">
                                @endif
                            </div>
