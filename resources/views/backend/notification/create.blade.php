...
<div class="col-12 ">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('announcement.store') }}" id="announcement_form" class="forms-sample" method="post">
                @csrf
                <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-dark" id="" name="title" value=""  placeholder="">
                                </div>
